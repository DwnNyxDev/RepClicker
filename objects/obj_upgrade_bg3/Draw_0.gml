...
draw_text(x,y-30,"Recruit Hero: Golem");
draw_set_font(fnt_RPS);
draw_text(x,y+30,"Cost: 1.5K");
}
else{
	var type = "Cost: ";
...
if(global.GolemLVL=25||global.GolemLVL=50||global.GolemLVL=100||global.GolemLVL=150){
   ...
   var rep_string = string(round(global.Golem_cost*multiplierUpgrade));
var pow=1;
var Multi="K";
...
if(!show_stats){
draw_set_font(fnt_Reputation);
   draw_text(x+75,y-35,"Golem   LVL    "+string(global.GolemLVL));
if(string_length(rep_string)<4){
	draw_set_font(fnt_RPS);
draw_text(x+75,y,type+string(global.Golem_cost*multiplierUpgrade));
}
else {
	draw_set_font(fnt_RPS);
draw_text(x+75,y,type+string_format((global.Golem_cost*multiplierUpgrade)/power(1000,pow),3,3)+Multi);
}
}
else{
	draw_set_halign(fa_left);
	draw_set_font(fnt_RPS)
	draw_text(x-20,y-20,"Golem   LVL    "+string(global.GolemLVL));
	if(string_length(rep_string)<4){
draw_text(x-20,y,type+string(global.Golem_cost*multiplierUpgrade));	
}
else {	
draw_text(x-20,y,type+string_format((global.Golem_cost*multiplierUpgrade)/power(1000,pow),3,3)+Multi);
}
...
var rps_string = ((global.GolemLVL*15)*power(2,global.Golem_multiplier))*frenzy_multi*(1+(global.SovereignLVL*25)/100);
RPC= ((global.GolemLVL*15)*power(2,global.Golem_multiplier))*frenzy_multi*(1+(global.SovereignLVL*25)/100);
